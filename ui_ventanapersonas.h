...
public:
    ...
    void setupUi(QMainWindow *ventanaPersonas)
    {
        ...
        textPersonas->setStyleSheet(QStringLiteral("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 255, 255, 192), stop:1 rgba(255, 255, 255, 228));"));
